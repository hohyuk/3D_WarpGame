...
void CDynamicMesh::Render_Meshes(LPD3DXEFFECT & pEffect, const _uint& iPassNum)
{
	Update_Animation();
...
_float CDynamicMesh::GetAccTime() const
{
	return m_pAniCtrl->GetAccTime();
}
...
void CDynamicMesh::Update_Animation()
{
	m_pAniCtrl->Play_Animation(m_fTimeDelta);
