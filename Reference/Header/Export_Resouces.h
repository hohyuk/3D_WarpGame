...
// ResourcesMgr
// Get
inline CVIBuffer*			Get_Buffer(const _ushort& wContainerIdx, const _tchar* pBufferTag);
inline LPDIRECT3DTEXTURE9	Get_NormalTexture(const _tchar* pTextureTag, const _uint& iIndex = 0);
...
// Adjust
inline void		Adjust_TerrainBuffer(const _ushort& wContainerIdx, const _tchar* pBufferTag, const _ulong& dwCntX, const _ulong& dwCntZ, const _ulong& dwVtxItv, const _float& fDetail = 20.f);
